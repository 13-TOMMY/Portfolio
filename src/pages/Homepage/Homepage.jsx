...
function Homepage() {
  ...
  return (
    <div className='Homepage-container'>
      ...
      <p>Hello, i am Tomasz Lis, a enthusiastic Front-end Developer based in Krakow, Poland. I love coding and i believe in the power of continuous learning, expanding my knowledge and skills every day.</p>
      </div>
      <div className={darkMode ? "hp-top-right-dark hp-top-right" : "hp-top-right-light hp-top-right"}>
      <img src="src/assets/photos/homepage-photo.png" alt="Photo of me" className='hp-top-right-img'/>
      </div>
      </div>
